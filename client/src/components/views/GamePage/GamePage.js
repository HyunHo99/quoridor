...
function GamePage(props) {
  ...
  return (
    <div>
              ...
              {val.map((x, index2) => {
                ...
                if (index2 % 2 === 0 && index % 2 === 1) {
                  if (gameboard.board[index][index2] === 1) {
                    return (
                      <img className="Row-Wall BackColor" src={Wall_Img}></img>
                    );
                  }
                  if (gameboard.board[index][index2] === -1) {
                    return (
                ...
                if (index % 2 === 0 && index2 % 2 === 1) {
                  if (gameboard.board[index][index2] === 1) {
                    return (
                      <img className="Col-Wall BackColor" src={Wall_Img}></img>
                    );
                  }
                  if (gameboard.board[index][index2] === -1) {
                    return (
      ...
      <button disabled={false} onClick={ChooseMoveHandler}>
        Choose Move
      </button>
      <button disabled={false} onClick={ChooseMakeWallHandler}>
        Choose MakeWall
      </button>
